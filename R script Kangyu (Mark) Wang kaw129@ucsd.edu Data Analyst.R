...
summary(tw_3)
stargazer(tw_0, tw_1, tw_3, out = "baseline.html", column.labels= c("(a)", "(b)", "(c)"),column.separate = c(1, 1), dep.var.labels = "ratio of net migration to 1994 population",
...
summary(tw_10)
stargazer(tw_5, tw_6, tw_7, tw_8, tw_9, tw_10, out = "controls.html", column.labels= c("(a)", "(b)", "(c)", "(d)", "(e)", "(f)"),column.separate = c(1, 1, 1, 1 , 1, 1), dep.var.labels = "ratio of net migration to 1994 population",
...
summary(tw_3_fdi_1)
stargazer(tw_0_fdi, tw_1_fdi, tw_3_fdi, tw_0_fdi_1, tw_1_fdi_1, tw_3_fdi_1, out = "baseline_fdi.html", column.labels= c("(a)", "(b)", "(c)", "(d)", "(e)", "(f)"),column.separate = c(1, 1), dep.var.labels = "ratio of net migration to 1994 population",
          add.lines = list(c("Year fixed effect", "yes", "yes", "yes", "yes", "yes", "yes"), c("Prefecture fixed effect", "yes", "yes", "yes", "yes", "yes", "yes")), model.numbers = FALSE,
...
tm_shape(prefecture_92_99_map)+tm_polygons("NM_to_1994", style="quantile", palette="Greens")+tm_borders(lwd=0.1, col="white")+tm_layout(title="Net Migration in 1998 to 1994 population", frame = FALSE, title.size = 1)
...
tm_shape(prefecture_92_99_map)+tm_polygons("SOE_dec_98", style="quantile")+tm_borders(lwd=0.1, col="white")+tm_layout(title="SOE downsizing in 1998 to 1994 population", frame = FALSE, title.size = 1)
